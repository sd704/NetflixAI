...
const GptSearchPage = () => {
    ...
    return (
        <div>
            ...
            <div className={`relative z-10 mt-48 ${selectedItem?.overview ? 'md:mt-40 xl:mt-40 2xl:mt-40' : 'md:mt-80 xl:mt-48 2xl:mt-80'}`}>
                <form className="w-11/12 md:w-10/12 xl:w-6/12 2xl:w-5/12 mx-auto p-5 rounded-xl bg-black/80 flex flex-col md:flex-row text-sm md:text-lg xl:text-sm 2xl:text-lg" onSubmit={(e) => e.preventDefault()}>
